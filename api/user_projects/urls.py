...
urlpatterns = [
    ...
    # Project Items (nested under list)
    path("<uuid:project_id>/items/", views.ProjectItemListCreateView.as_view(), name="ptoject_items"),
    ...
    path("<uuid:project_id>/items/<uuid:item_id>/", views.ProjectItemDetailView.as_view(), name="project_item-detail"),
